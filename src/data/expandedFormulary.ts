import { DrugFormularyItem } from '../types';
...
export const EXPANDED_FORMULARY: DrugFormularyItem[] = [
  {
    ...
    "category": "Neonatal / Foal-Specific Drugs (Antimicrobials & Antifungals)",
    "doseMin": 21.0,
    "doseMax": 25.0,
    "doseDefault": 21.0,
    "doseUnit": "mg/kg",
  ...
  },
  {
    ...
    "name": "Diazepam",
    "brandName": "Valium",
    "category": "Anticonvulsants / Neurologic",
    "doseMin": 0.05,
    "doseMax": 0.2,
    "doseDefault": 0.05,
    "doseUnit": "mg/kg",
  ...
  },
  {
    ...
    "category": "Gastrointestinal \u2014 Ulcer Prophylaxis/Treatment",
    "doseMin": 4.0,
    "doseMax": 4.0,
    "doseDefault": 4.0,
    "doseUnit": "mg/kg",
  ...
  },
  {
    ...
    "brandName": "Amicar",
    "category": "Hemostatic / Coagulation",
    "doseMin": 20.0,
    "doseMax": 40.0,
    "doseDefault": 20.0,
    "doseUnit": "mg/kg",
  ...
  },
  {
    ...
    "name": "Dexamethasone",
    "brandName": "Azium",
    "category": "Immunosuppressive / Anti-inflammatory (Steroids/Others)",
    "doseMin": 0.05,
    "doseMax": 0.2,
    "doseDefault": 0.05,
    "doseUnit": "mg/kg",
  ...
  },
  {
    ...
    "name": "Methocarbamol",
    "brandName": "Robaxin",
    "category": "Muscle Relaxants / Myopathy",
    "doseMin": 10.0,
    "doseMax": 25.0,
    "doseDefault": 10.0,
    "doseUnit": "mg/kg",
  ...
  },
  {
    ...
    "name": "Chlorhexidine",
    "brandName": "",
    "category": "Dermatologic / Topical & Antiparasitic",
    "doseMin": 0,
    "doseMax": 0,
    "doseDefault": 0,
    "doseUnit": "-",
  ...
  },
  {
    ...
    "name": "Yohimbine",
    "brandName": "Yobine",
    "category": "Sedation Reversal / Emergency",
    "doseMin": 0.075,
    "doseMax": 0.12,
    "doseDefault": 0.075,
    "doseUnit": "mg/kg",
